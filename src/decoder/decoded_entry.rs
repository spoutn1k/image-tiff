...
use crate::tags::Type;
use crate::{TiffError, TiffFormatError, TiffKind, TiffResult};
...
use crate::ifd::{
    BufferedEntry,
    Value::{
        self, Ascii, Byte, Double, Float, Ifd, IfdBig, List, Rational, SRational, Short, Signed,
...
impl<K: TiffKind> DecodedEntry<K> {
    ...
    fn r(&self, byte_order: ByteOrder) -> SmartReader<io::Cursor<Vec<u8>>> {
        SmartReader::wrap(io::Cursor::new(self.offset.clone()), byte_order)
    }
